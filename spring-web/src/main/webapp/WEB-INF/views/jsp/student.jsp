...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			...
			<table>
				<form:form method="POST" action="student/search" modelAttribute="student">
					<tr>
						<td>Id del student</td>
						<td><form:input path="idStudent"/></td>
					</tr>
					<tr><td><input type="submit" class="btn" value="search"/></td></tr>
				</form:form>
			</table>
			<form:form method="POST" action="student/create">
				<input type="submit" class="btn" value="Create new student"/>
			</form:form>
		</div>
	</div>
</div>
