...
<div class="container">
	<div class="row">
		<div class="col-md-4">
			...
			<table>
				<form:form method="POST" action="category/search" modelAttribute="category">
					<tr>
						<td>Id del category</td>
						<td><form:input path="idCategory"/></td>
					</tr>
					<tr><td><input type="submit" class="btn" value="search"/></td></tr>
				</form:form>
			</table>
			<form:form method="POST" action="category/create">
				<input type="submit" class="btn" value="Create new category"/>
			</form:form>
		</div>
	</div>
</div>
